...
class _0x520715 extends _0x49bd9d {
  ...
  async dragonBoat2024_finishTask(_0x2fec7d, _0x26b7dd = {}) {
    try {
      ...
      _0x17f75a?.["success"]
        ? (this.log("中秋完成任务[" + _0x2fec7d.taskName + "]成功"),
  ...
  async dragonBoat2024_fetchMixTaskReward(_0x199ce9, _0x89a081 = {}) {
    try {
      ...
      if (_0xe9f22d?.["success"]) {
        ...
        this.log(
          "中秋领取任务[" + _0x199ce9.taskName + "]奖励失败: " + _0x402c01
        );
  ...
  async dragonBoat2024_boat_win(_0x41d2ec = 1, _0x401fcd = {}) {
    ...
    try {
      ...
      if (_0x17474d?.["success"]) {
        ...
        _0x1b6957.length
          ? this.log(
              "中秋推月饼第" + _0x41d2ec + "关通关成功: " + _0x1b6957.join(", ")
            )
          : this.log("中秋推月饼第" + _0x41d2ec + "关通关成功");
      } else {
        let _0x43deae =
          _0x17474d?.["errorMessage"] ||
          (_0x17474d ? JSON.stringify(_0x17474d) : "无返回");

        this.log("中秋推月饼第" + _0x41d2ec + "关失败: " + _0x43deae);
    ...
    try {
      ...
      }
      {
        ...
        if (_0x19ac46?.["success"]) {
          ...
          this.log(
            "中秋金币: " + this.coin + ", 发财卡: " + this.rich_card,
            _0x35bbb2
          );
          ...
          this.log("中秋可以抽发财卡池" + _0x252cd5 + "次");
  ...
  async dragonBoat2024_pushCoin(_0x29d4dc = {}) {
    try {
      ...
      if (_0xf2ce07?.["success"]) {
        ...
        _0x50c982.length
          ? this.log("中秋推金币成功: " + _0x50c982.join(", "))
          : this.log("中秋推金币成功, 没有获得奖品");
      } else {
        this.log(
          "中秋推金币失败: " +
  ...
  async dragonBoat2024_coinStatus_checkDraw(_0x252dbf = {}) {
    try {
      ...
      if (_0x562f60?.["success"]) {
        ...
        this.log("中秋可以抽发财卡池" + _0x244ca0 + "次");
  ...
  async dragonBoat2024_task(_0xbf0e9e = {}) {
    ...
    if (_0xfc310e < 1725253584000 || _0xfc310e > 1726761600000) {
      return;
    }
